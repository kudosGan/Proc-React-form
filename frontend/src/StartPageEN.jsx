...
// English landing page. Kept as its own component (separate from
// StartPageFR.jsx) so each language can be edited/debugged in isolation.
function StartPageEN({ onBusinessOwner, onBuyer, onManager, onDirector, lang, setLang }) {
  return (

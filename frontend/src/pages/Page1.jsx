...
function Page1({ formData, setFormData }) {
  ...
  // Selecting one type deselects the others
  const selectType = (type) => {
    setFormData({
      ...formData,
      goodsSelected: type === 'goods',
      servicesSelected: type === 'services',
      constructionSelected: type === 'construction',
    })
  }
      ...
      <Section title="PART 1 – CLIENT CONTACT INFORMATION">
        ...
        <table className="form-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <TableDropdown
                  ...
                  onChange={(e) => setFormData({ ...formData, clientBranch: e.target.value })}
                />
              </td>
            </tr>
            ...
            <tr>
              <td colSpan="2">
                <div className="subsection-title">Business Owner</div>
              </td>
            </tr>
            ...
            <tr>
              <td>
                <TableField
                  ...
                  onChange={(e) => setFormData({ ...formData, businessOwnerFirstName: e.target.value })}
                />
              </td>
              <td>
                <TableField
                  ...
                  onChange={(e) => setFormData({ ...formData, businessOwnerLastName: e.target.value })}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <TableDropdown
                  ...
                  onChange={(e) => setFormData({ ...formData, businessOwnerBranch: e.target.value })}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <TableField
                  ...
                  onChange={(e) => setFormData({ ...formData, goodsDeliveryDate: e.target.value })}
                />
              </td>
            </tr>
              ...
              <td>
                <div className="grid-2">
                  <TableField
                    ...
                    onChange={(e) => setFormData({ ...formData, servicesStartDate: e.target.value })}
                  />
                  <TableField
                    label="End Date (YYYY-MM-DD):"
                    type="date"
                    value={formData.servicesEndDate}
                    onChange={(e) => setFormData({ ...formData, servicesEndDate: e.target.value })}
                  />
                </div>
              </td>
            </tr>
              ...
              <td>
                <div className="checkbox-field">
                  <input
                    ...
                    onChange={() => selectType('construction')}
                  />
            ...
            <tr>
              ...
              <td>
                <YesNoField
                  ...
                  onChange={(value) => setFormData({ ...formData, procurementStrategy: value })}
                />
              </td>
            </tr>
            ...
            <tr>
              <td colSpan="2">
                <StrategyOptions
                  ...
                  onChange={(value) => setFormData({ ...formData, strategyOptions: value })}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <YesNoField
                  ...
                  onChange={(value) => setFormData({ ...formData, continuationRequired: value })}
                />
              </td>
            </tr>
              ...
              <td colSpan="2">
                ...
                <div className="full-width-textarea">
                  <TextAreaField
                    ...
                    onChange={(e) => setFormData({ ...formData, continuationDetails: e.target.value })}
                  />
                </div>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <YesNoField
                  ...
                  onChange={(value) => setFormData({ ...formData, subsequentNeed: value })}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <YesNoField
                  ...
                  onChange={(value) => setFormData({ ...formData, alternativesConsidered: value })}
                />
              </td>
            </tr>
            ...
            <tr>
              <td colSpan="2">
                ...
                <TextAreaField
                  ...
                  onChange={(e) => setFormData({ ...formData, alternativeDetails: e.target.value })}
                />
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <YesNoField
                  ...
                  onChange={(value) => setFormData({ ...formData, functionalApproval: value })}
                />
              </td>
            </tr>

...
function Page4({ formData, setFormData }) {
  ...
  const handleSignSubmit = (e) => {
    ...
    if (!agreed || !firstName.trim() || !lastName.trim()) {
      return
    }
    ...
    <FormLayout>
      ...
      <Section title="PART 5 – FINANCIAL INFORMATION AND AUTHORIZATION">
        ...
        <div className="section-body">
          ...
          <div className="auth-group-title">
            Recommended
          </div>
                ...
                <td style={{ width: '28%' }}>
                  ...
                  <TableField
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        recommendedTitle: e.target.value
                      })
                    }
                  />
                  ...
                  <div className="meta-inline">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          responsibilityCentreManager: e.target.value
                        })
                      }
                    />
                  ...
                  <div className="meta-inline">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          responsibilityTitle: e.target.value
                        })
                      }
                    />
                  ...
                  <div className="meta-inline">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          responsibilityBranch: e.target.value
                        })
                      }
                    >
                  ...
                  <div className="meta-inline">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          responsibilityDivision: e.target.value
                        })
                      }
                    />
              ...
              {formData.financialRows.map((row, index) => (
                ...
                <tr key={index}>
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        if (formData.financialRows.length > 1) {
                          ...
                          const updatedRows =
                            formData.financialRows.slice(0, -1)

                          setFormData({
                            ...formData,
                            financialRows: updatedRows
                          })
                  ...
                  <td>
                    ...
                    <TableField
                      value={row.generalLedger}
                      onChange={(e) => {

                        const updatedRows =
                          [...formData.financialRows]

                        updatedRows[index].generalLedger =
                          e.target.value
                  ...
                  <td>
                    ...
                    <TableField
                      value={row.programActivity}
                      onChange={(e) => {

                        const updatedRows =
                          [...formData.financialRows]

                        updatedRows[index].programActivity =
                          e.target.value
                  ...
                  <td>
                    ...
                    <TableField
                      ...
                      onChange={(e) => {
                        ...
                        updatedRows[index].internalOrder =
                          e.target.value
          ...
          <table
            className="signature-grid-table"
            style={{ marginTop: '5px' }}
          >
            ...
            <label>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    statementOfRequirement: e.target.checked
                  })
                }
              />
            ...
            <label>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    statementOfWork: e.target.checked
                  })
                }
              />
            ...
            <label>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    investmentAuthorityRequest: e.target.checked
                  })
                }
              />
      ...
      <Section title="PART 7 – ADDITIONAL NOTES TO DESIGNATED PROCUREMENT OFFICE">
        ...
        <div
          className="section-body bg-blue-light"
          style={{ padding: '10px' }}
        >
          ...
          <textarea
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                procurementNotes: e.target.value
              })
            }
          />
